...
public class AdapterPengumuman2 extends RecyclerView.Adapter<AdapterPengumuman2.ViewHolder> {
    ...
    public AdapterPengumuman2(Pengumuman Pengumuman, ArrayList<HashMap<String ,String >>list_data)
    {
    ...
    @Override
    public AdapterPengumuman2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_row, null);
        return new AdapterPengumuman2.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final AdapterPengumuman2.ViewHolder holder, final int position) {
