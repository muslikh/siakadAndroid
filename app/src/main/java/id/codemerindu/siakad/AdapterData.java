...
public class AdapterData extends RecyclerView.Adapter<AdapterData.HolderData> {
    ...
    public void onBindViewHolder(HolderData holder, int position) {
        ...
        holder.tvthnmasuk.setText(md.getThnmasuk());
    ...
    {
        TextView tvnama,tvnisn,tvthnmasuk,tvjurusan;
        ModelData md;
        ...
        public  HolderData (View view)
        {
            ...
            tvthnmasuk = (TextView) view.findViewById(R.id.tahunmasuk);
            tvjurusan = (TextView) view.findViewById(R.id.jurusan);

            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent update = new Intent(context, Pendaftar.class);
